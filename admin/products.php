			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						...
						<span class="float:right"><a class="btn btn-warning btn-block btn-sm col-sm-2 float-right" href="index.php?page=manage_product" id="new_product">
					New Entry
				</a></span>
					</div>
					<div class="card-body">
							...
							<tbody>
								...
								<tr data-id= '<?php echo $row['id'] ?>'>
									...
									<td class="text-center">
										<button class="btn btn-primary edit_product" type="button" data-id="<?php echo $row['id'] ?>" >Edit</button>
										<button class="btn btn-danger delete_product" type="button" data-id="<?php echo $row['id'] ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
